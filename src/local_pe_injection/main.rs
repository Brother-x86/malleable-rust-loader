...
// TODO, ici en paramètre, on donne le type (exe/dll) et ensuite le vec_u8 et la cmdline -> qui sera Args::parse
pub fn local_pe_injection() -> Result<(), Box<dyn std::error::Error>> {
    let args = Args::parse();
