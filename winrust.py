...
parser.add_argument('--mem1',default=False,action='store_true',help='add file to memory 1')
parser.add_argument('--mem2',default=False,action='store_true',help='add file to memory 2')
parser.add_argument('--mem3',default=False,action='store_true',help='add file to memory 3')
parser.add_argument('--mem4',default=False,action='store_true',help='add file to memory 4')
